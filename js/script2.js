...
!(function(e) {
    ...
    ((r = function(e, t) {
        ...
        (a.$current = {
            month: isNaN(this.month) || null == this.month ?
                new Date().getMonth() :
                this.month,
            year: isNaN(this.year) || null == this.year ?
    ...
    (r.prototype.formatDate = function(e, t, a) {
        ...
        (e = []);
        for (
            var r = d.extend([], t.separators), s = 0, l = t.parts.length; s <= l; s++
        )
    ...
    (r.prototype.hasSameDayEventType = function(e, t) {
        for (var a = this, n = 0, i = 0; i < a.options.calendarEvents.length; i++)
            if (a.options.calendarEvents[i].date instanceof Array)
                for (
                    var o = a.getBetweenDates(a.options.calendarEvents[i].date), r = 0; r < o.length; r++
                )
